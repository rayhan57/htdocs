    ...
    <div class="container register rounded-3 p-3 text-white">
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" autofocus autocomplete="off" name="username" />
            </div>
            <div class="mb-3">
            ...
            <button style="width: 100%; border-radius: 20px;" type="submit" class="btn btn-primary" name="register">
                Daftar
            </button>
            <p class="mt-3 text-secondary">
                Sudah memiliki akun? Silahkan
                <a href="login.php" style="text-decoration: none; font-weight: bold">Masuk</a>
            </p>
        </form>
    </div>
